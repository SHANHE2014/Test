...
public class UpdateManager {
    ...
    private final static String XML_URL = "http://img.weitanr.com/download/apk/weitanr_custom_version.xml";
    ...
    private int getVersionCode(Context context) {
        ...
        try {
            ...
            versionCode = context.getPackageManager().getPackageInfo(
                    "com.kunzhuo.android.weitanr", 0).versionCode;
    ...
    private void showNoticeDialog() {
        ...
        builder.setTitle(R.string.soft_update_title).setMessage(
                mHashMap.get("info"));
        builder.setOnPositiveListener(R.string.soft_update_update_btn,
                new OnClickListener() {
                    @Override
    ...
    private void showDownloadDialog() {
        ...
        View v = LayoutInflater.from(mContext).inflate(
                R.layout.soft_update_progress, null);
